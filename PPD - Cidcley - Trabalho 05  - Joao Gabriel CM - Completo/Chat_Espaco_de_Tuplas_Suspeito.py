...
def janela_Chat_Geral_Usuario(nome_usuario,nome_sala_chat):
    ...
    bg_label_nome_cliente.config(bg='white')
    ...
    text_area.insert(tk.INSERT,"<Você entrou> Bem vindo ao ")
    text_area.insert(tk.INSERT," Chat! ~", 'msg_inicial_user')
    text_area.insert(tk.INSERT,"\n\n...\n\n")
    text_area.tag_config('msg_inicial_user', background = 'black', foreground='red')
...
def janela_Espiao():
    ...
    text_area.insert(tk.INSERT," - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -", 'msg_inicial')
    text_area.insert(tk.INSERT,"\n...\n\n\n\n\n\n\n", 'msg_inicial')
    text_area.tag_config('msg_inicial', background = 'black', foreground='red')
    ...
    while(True):
        if flag_Monitora_Novas_Mensagens == 1:
            ...
            if(msg_recebida[0][0] == "Todos"):
                ...
                #ScrolledText.tag_config('msg_SUS', background = 'red', foreground='green')
            elif(msg_recebida[0][0] == nome_usuario):
                ScrolledText.insert(tk.INSERT,msg_recebida[0][1]+"\n", 'msg_privada')
                ScrolledText.tag_config('msg_privada', background='black',foreground='white')
            flag_Monitora_Novas_Mensagens = 0
        else:
            pass
